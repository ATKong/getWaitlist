...
function gw_make_social_links() {
	...
	if (
		(a &&
			e.push(
				`<?xml version="1.0" encoding="UTF-8"?><a class="${gw_ml_1} ${gw_mr_1}" href="${a}" target="_blank" xmlns="http://www.w3.org/2000/svg"><svg width="37" height="37" viewBox="0 0 46 46" xmlns="http://www.w3.org/2000/svg"><path d="m22.821 45.643c12.604 0 22.822-10.218 22.822-22.822 0-12.604-10.218-22.821-22.822-22.821-12.604 0-22.821 10.218-22.821 22.821 0 12.604 10.218 22.822 22.821 22.822z" fill="#fff"/><path d="m22.821 45.643c12.604 0 22.822-10.218 22.822-22.822 0-12.604-10.218-22.821-22.822-22.821-12.604 0-22.821 10.218-22.821 22.821 0 12.604 10.218 22.822 22.821 22.822z" fill="${gw_border_color}" fill-opacity="0.0"/><path d="m20.801 32.964v-9.0731h-3.0508v-3.6055h3.0508v-2.8526c0-1.5056 0.4226-2.6744 1.2678-3.5064 0.8453-0.8321 1.9678-1.2481 3.3678-1.2481 1.1358 0 2.0602 0.0528 2.7734 0.1585v3.2092h-1.9018c-0.7132 0-1.2018 0.1585-1.4659 0.4755-0.2114 0.2641-0.317 0.6867-0.317 1.2678v2.4961h3.3677l-0.4754 3.6055h-2.8923v9.0731h-3.7243z" fill="${o}"/></svg></a>`
			),
		t &&
			e.push(
