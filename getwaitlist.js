...
function gw_make_waitlist_widget(e) {
	...
	if (
		...
		a
            ...
            <div>
                <p style="color: #8989A8" class="${gw_pb_2}${gw_text_center}${gw_text_xl}">Fill out the form and secure a spot on our waiting list!</p>
            </div>
        `)
			: (gw_waitlist_container.innerHTML = ''),
		'SUBMIT' === e)
